    ...
    <section class="mp-shell" aria-label="Municipal Panel V2">
      <header class="mp-hero">
        <nav class="mp-nav" aria-label="Navegación Municipal Panel V2">
          ...
          <div class="mp-nav-actions"><a href="#tickets">Tickets</a><a href="#brigadas">Brigadas</a><a href="#mapa">Mapa</a><a href="#actividad">Actividad</a></div>
        </nav>
