...
function renderPortal(context) {
  ...
  const institutionalUrl = context.institutionalUrl ?? './frontend/modules/institutional-content/demo.html';
  ...
  return `
    <section class="cp-shell" aria-label="Portal Ciudadano V2">
      <header class="cp-hero" data-screen="inicio">
        <nav class="cp-nav" aria-label="Navegación del portal ciudadano">
          ...
          <div class="cp-nav-actions">
            <button class="cp-link" type="button" data-cp-go="institucional">Conoce tu municipio</button>
      ...
      <main class="cp-main">
        ...
        <section class="cp-screen" data-cp-screen="institucional" aria-labelledby="institucional-title">
          <div class="cp-section-heading">
            <span class="cp-eyebrow">Conoce tu municipio</span>
            <h2 id="institucional-title">Historia, lugares emblemáticos y autoridades municipales</h2>
            <p>Acceso seguro y limitado al módulo institucional V2. Mantiene intactos los flujos de reportar y consultar tickets.</p>
          </div>
          <div class="cp-institutional-card">
            <ul>
              <li>Historia del municipio</li><li>Lugares emblemáticos</li><li>Autoridades municipales</li><li>Alcalde</li><li>Vicealcaldesa</li><li>Concejo municipal</li>
            </ul>
            <a class="cp-primary" href="${institutionalUrl}">Abrir Conoce tu municipio</a>
          </div>
        </section>
