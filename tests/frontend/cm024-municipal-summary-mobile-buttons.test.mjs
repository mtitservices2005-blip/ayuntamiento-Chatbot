...
assert.match(html, /id="municipal-summary"/);
assert.match(app, /function buildMunicipalSummary\(profile = municipalConfig\)/);
assert.match(app, /renderMunicipalSummary\(municipalConfig\)/);
